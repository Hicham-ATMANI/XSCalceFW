...
def GetTheRecoilVariation(Charge, Energy):
        ...
        RecoilSystVariation.append(ROOT.TFile('/eos/user/h/hatmani/OldData/5TeVInputs/Processing/pTW_Input/pTWanalysis_ptw'+ Charge+'_MC_'+str(Energy)+'TeV/RecoilVar/Merge/mc16_'+str(Energy)+'TeV.varSET_SYSbin1.root'))
        '''RecoilSystVariation.append(ROOT.TFile('/eos/user/h/hatmani/OldData/5TeVInputs/Processing/pTW_Input/pTWanalysis_ptw'+ Charge+'_MC_'+str(Energy)+'TeV/RecoilVar/Merge/mc16_'+str(Energy)+'TeV.varRESPONSE_SYS_DOWNbin1.root'))
        RecoilSystVariation.append(ROOT.TFile('/eos/user/h/hatmani/OldData/5TeVInputs/Processing/pTW_Input/pTWanalysis_ptw'+ Charge+'_MC_'+str(Energy)+'TeV/RecoilVar/Merge/mc16_'+str(Energy)+'TeV.varRESPONSE_EXTSYS_DOWNbin1.root'))
        RecoilSystVariation.append(ROOT.TFile('/eos/user/h/hatmani/OldData/5TeVInputs/Processing/pTW_Input/pTWanalysis_ptw'+ Charge+'_MC_'+str(Energy)+'TeV/RecoilVar/Merge/mc16_'+str(Energy)+'TeV.varRESOLUTION_EXTSYS_DOWNbin1.root'))
        
        for i in range(1, 20):
            RecoilSystVariation.append(ROOT.TFile('/eos/user/h/hatmani/OldData/5TeVInputs/Processing/pTW_Input/pTWanalysis_ptw'+ Charge+'_MC_'+str(Energy)+'TeV/RecoilVar/Merge/mc16_'+str(Energy)+'TeV.varRESPONSE_STAT0_DOWNbin'+str(i)+'.root'))
            RecoilSystVariation.append(ROOT.TFile('/eos/user/h/hatmani/OldData/5TeVInputs/Processing/pTW_Input/pTWanalysis_ptw'+ Charge+'_MC_'+str(Energy)+'TeV/RecoilVar/Merge/mc16_'+str(Energy)+'TeV.varRESPONSE_STAT1_DOWNbin'+str(i)+'.root'))

        for i in range(1, 12):
            RecoilSystVariation.append(ROOT.TFile('/eos/user/h/hatmani/OldData/5TeVInputs/Processing/pTW_Input/pTWanalysis_ptw'+ Charge+'_MC_'+str(Energy)+'TeV/RecoilVar/Merge/mc16_'+str(Energy)+'TeV.varRESOLUTION_STAT0_DOWNbin'+str(i)+'.root'))
            RecoilSystVariation.append(ROOT.TFile('/eos/user/h/hatmani/OldData/5TeVInputs/Processing/pTW_Input/pTWanalysis_ptw'+ Charge+'_MC_'+str(Energy)+'TeV/RecoilVar/Merge/mc16_'+str(Energy)+'TeV.varRESOLUTION_STAT1_DOWNbin'+str(i)+'.root'))
	'''
	
	
	#RecoilSystVariation.append(ROOT.TFile('/eos/user/h/hatmani/DataSets/DataSets_5TeV/pTWanalysis_ptw'+ Charge+'_MC_'+str(Energy)+'TeV/RecoilVar/Merge/mc16_'+str(Energy)+'TeV.varSET_SYSbin1.root'))
        #RecoilSystVariation.append(ROOT.TFile('/eos/user/h/hatmani/DataSets/DataSets_5TeV/pTWanalysis_ptw'+ Charge+'_MC_'+str(Energy)+'TeV/RecoilVar/Merge/mc16_'+str(Energy)+'TeV.varRESPONSE_SYS_DOWNbin1.root'))
        #RecoilSystVariation.append(ROOT.TFile('/eos/user/h/hatmani/DataSets/DataSets_5TeV/pTWanalysis_ptw'+ Charge+'_MC_'+str(Energy)+'TeV/RecoilVar/Merge/mc16_'+str(Energy)+'TeV.varRESPONSE_EXTSYS_DOWNbin1.root'))
        #RecoilSystVariation.append(ROOT.TFile('/eos/user/h/hatmani/DataSets/DataSets_5TeV/pTWanalysis_ptw'+ Charge+'_MC_'+str(Energy)+'TeV/RecoilVar/Merge/mc16_'+str(Energy)+'TeV.varRESOLUTION_EXTSYS_DOWNbin1.root'))
	
	#for i in range(1, 20):
        #    RecoilSystVariation.append(ROOT.TFile('/eos/user/h/hatmani/DataSets/DataSets_5TeV/pTWanalysis_ptw'+ Charge+'_MC_'+str(Energy)+'TeV/RecoilVar/Merge/mc16_'+str(Energy)+'TeV.varRESPONSE_STAT0_DOWNbin'+str(i)+'.root'))
        #    RecoilSystVariation.append(ROOT.TFile('/eos/user/h/hatmani/DataSets/DataSets_5TeV/pTWanalysis_ptw'+ Charge+'_MC_'+str(Energy)+'TeV/RecoilVar/Merge/mc16_'+str(Energy)+'TeV.varRESPONSE_STAT1_DOWNbin'+str(i)+'.root'))

        #for i in range(1, 12):
        #    RecoilSystVariation.append(ROOT.TFile('/eos/user/h/hatmani/DataSets/DataSets_5TeV/pTWanalysis_ptw'+ Charge+'_MC_'+str(Energy)+'TeV/RecoilVar/Merge/mc16_'+str(Energy)+'TeV.varRESOLUTION_STAT0_DOWNbin'+str(i)+'.root'))
        #    RecoilSystVariation.append(ROOT.TFile('/eos/user/h/hatmani/DataSets/DataSets_5TeV/pTWanalysis_ptw'+ Charge+'_MC_'+str(Energy)+'TeV/RecoilVar/Merge/mc16_'+str(Energy)+'TeV.varRESOLUTION_STAT1_DOWNbin'+str(i)+'.root'))
...
def GetTheCalibVariation(Charge, Energy):
	...
	for i in range(1, 25):
            CalibSystVariation.append(ROOT.TFile('/eos/user/h/hatmani/DataSets/DataSets_5TeV/pTWanalysis_ptw'+ Charge+'_MC_'+str(Energy)+'TeV/ElCalibVar/Merge/mc16_'+str(Energy)+'TeV.varscaleDownbin'+str(i)+'.root'))

        for i in range(1, 25):
            CalibSystVariation.append(ROOT.TFile('/eos/user/h/hatmani/DataSets/DataSets_5TeV/pTWanalysis_ptw'+ Charge+'_MC_'+str(Energy)+'TeV/ElCalibVar/Merge/mc16_'+str(Energy)+'TeV.varcDownbin'+str(i)+'.root'))
...
def GetTheBias(responseM, dataCorrected, mig_hist, Niteration, VarMin, VarMax, Channel, Energy, Variable):
	...
	# define the output:
	OutputFile = TFile("output_"+Channel+str(Energy)+"/"+Variable+"_2d/Bias_"+Channel+str(Energy)+".root",'RECREATE')
...
def SumBackground(Input_Bkgd1, Input_Bkgd2, Input_Bkgd3, Input_Bkgd5, Input_Bkgd4, Channel, Var ):
	...
	Background_W        = Input_Bkgd1.Get(  Channel + "Selection/el_Eta_pt1_cut7" )
	Background_Z        = Input_Bkgd2.Get(  Channel + "Selection/el_Eta_pt1_cut7" )
	Background_Dilepton = Input_Bkgd3.Get(  Channel + "Selection/el_Eta_pt1_cut7" )
	Background_Top      = Input_Bkgd5.Get(  Channel + "Selection/el_Eta_pt1_cut7" )
	
	Background_Total    = Background_W.Clone("Background_Total")
	for i in range(0, Background_Total.GetNbinsX()):
	    Background_Total.SetBinContent(i+1, Background_W.GetBinContent(i+1)+Background_Z.GetBinContent(i+1)+Background_Dilepton.GetBinContent(i+1)+ Background_Top.GetBinContent(i+1))
