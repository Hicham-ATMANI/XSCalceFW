...
class CrossSection:
    ...
    def GetDiffernetialXsPlotTest(self, Summarize_minusenu5, Energy, Indice, Name, Lum):
        ...
        DXs.SetLineWidth(2)
        DXs.SetLineColor(2)
        DXs.GetXaxis().SetLabelSize(0.045)
        DXs.GetXaxis().SetTitleSize(0.045)
        DXs.GetYaxis().SetLabelSize(0.045)
        DXs.GetYaxis().SetTitleSize(0.045)
        DXs.GetYaxis().SetTitle("d#sigma / dp_{l}^{T}")
        DXs.GetXaxis().SetTitle("p_{l}^{T} [GeV]")
        DXs.GetXaxis().SetTitleOffset(1.5)
        DXs.GetYaxis().SetTitleSize(0.05)
        ...
        Ratio1.GetXaxis().SetLabelSize(0.045)
        Ratio1.GetXaxis().SetTitleSize(0.045)
        Ratio1.GetYaxis().SetLabelSize(0.045)
        Ratio1.GetYaxis().SetTitleSize(0.045)
        Ratio1.GetXaxis().SetTitleOffset(1.5)
        Ratio1.GetYaxis().SetTitleSize(0.05)
	...
	for i in range(1, 1 + Uncer.GetNbinsX()):
		...
		Uncer.SetBinContent(i, 1  )
	    	Uncer.SetBinError(i, sqrt(Uncer.GetBinContent(i)) / HUnfolded.GetBinContent(i) )
	...
	Ratio1 = DXs.Clone("Ratio1")
        ...
        DXs.GetYaxis().SetRangeUser(0.4,1.3)
        DXs.GetYaxis().SetTitle("d#sigma / dp_{l}^{T}")
        DXs.GetXaxis().SetTitle("p_{l}^{T} [GeV]")
        DXs.GetXaxis().SetTitleOffset(1.5)
        DXs.GetYaxis().SetTitleSize(0.05)
