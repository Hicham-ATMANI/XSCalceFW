...
class OpitmisationStudy:
        ...
        def StatStudy(self, inputFile, IterMin, IterMax, mTmin, mTmax, channel, Var):
            ...
            pylab.plot(x, StatError,   marker='o', label= str(Nbin) + ' bin '  )
		...
		if  (channel.find("enu")  != -1):        
		    ...
		    TrigCovMatrix    = Syst_TrigSys.Get(  "TrigSys_Covariance_Iter"   + str(compteur))
                    RecoCovMatrix    = Syst_RecoSys.Get(  "RecoSys_Covariance_Iter"   + str(compteur))
        ...
        def TotalSystematicStudy(self, inputFile, Bias, TrigSF, RecoSF, IsoSF, IdSF, Calib, Recoil, IterMin, IterMax, mTmin, mTmax, channel, Var):
            ...
            while compteur <= IterMax:
                ...
                if  (channel.find("enu")  != -1):
                    ...
                    TrigCovMatrix    = TrigSF.Get(  "TrigSys_Covariance_Iter"   + str(compteur))
                    RecoCovMatrix    = RecoSF.Get(  "RecoSys_Covariance_Iter"   + str(compteur))
