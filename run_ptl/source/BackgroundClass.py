...
class BackgroundClass:
    ...
    def BackgroundPlotspTlepton(self, data, Signal, Background_Top, Background_diboson, Background_W, Background_Z, Background_MiltiJet, Uncertainties, Indice, channel, Energy):
        ...
        Uncertainties           = Uncertainties.Get('Systemat')                                  # Uncertainties
        ...
        HUncertainties      = TH1F("HUncertainties",        "HUncertainties",       100, 0, 100)    
        HUncertaintiesDown  = TH1F("HUncertaintiesDown",    "HUncertaintiesDown",   100, 0, 100)
        ...
        while i < 101:
            ...
            HUncertainties.SetBinContent(i,         1+(Uncertainties.GetBinContent(i)/100))
            HUncertaintiesDown.SetBinContent(i,     1-(Uncertainties.GetBinContent(i)/100))
        ...
        Legend.AddEntry(MCTotal,"MC");
        Legend.AddEntry(HUncertainties,"Uncer.");

        Legend2 = ROOT.TLegend(0.72,0.6,0.88,0.9)
    ...
    def BackgroundPlotsetalepton(self, data, Signal, Background_Top, Background_diboson, Background_W, Background_Z, Background_MiltiJet, Uncertainties, Indice, channel, Energy):
	...
	for i in range(1, len(RecoBin)):
        ...
        Legend = ROOT.TLegend(0.4,0.75,0.7,0.9)
        Legend.AddEntry(Hdata,"Data");
        Legend.AddEntry(MCTotal,"MC");
        Legend.AddEntry(HUncertainties,"Uncer.");

        Legend2 = ROOT.TLegend(0.55,0.75,0.74,0.9)
        Legend2.AddEntry(HBackgroundW,"W^{+-} #rightarrow l^{+-}v","f");
        Legend2.AddEntry(HBackgroundZ,"Z #rightarrow ll","f");
        Legend2.AddEntry(HBackgroundDiboson,"Diboson","f")

        Legend3 = ROOT.TLegend(0.72,0.81,0.88,0.9)
        Legend3.AddEntry(HBackgroundMultijet,"Multijet","f");
        Legend3.AddEntry(HBackgroundTop,"Top","f");
    ...
    def BackgroundPlotspTW(self, data, Signal, Background_Top, Background_diboson, Background_W, Background_Z, Background_MiltiJet, Uncertainties, Indice, channel, Energy):
        ...
        Legend = ROOT.TLegend(0.6,0.45,0.88,0.85)
        Legend.AddEntry(Hdata,"data");
        Legend.AddEntry(MCTotal,"Signal+Bkg");
        Legend.AddEntry(HBackgroundW,"W^{+-} #rightarrow l^{+-}v","f");
        Legend.AddEntry(HBackgroundZ,"Z #rightarrow ll","f");
        Legend.AddEntry(HBackgroundDiboson,"Diboson","f");
        Legend.AddEntry(HBackgroundMultijet,"Multijet","f");
