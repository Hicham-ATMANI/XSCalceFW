...
#Summarize_plusenu5  = ROOT.TFile.Open("/afs/cern.ch/work/h/hatmani/HistMaker_v1/Plotting/RooUnfold/buckup/old/output_Wplusenu5/elPt/Summarize_Wplusenu5.root")
Summarize_plusenu5  = ROOT.TFile.Open("/afs/cern.ch/work/h/hatmani/HistMaker_v1/Plotting/RooUnfold/buckup/old/output_Wplusenu5/mT/Summarize_Wplusenu5.root")
Bias_plusenu5       = ROOT.TFile.Open("/afs/cern.ch/work/h/hatmani/HistMaker_v1/Plotting/RooUnfold/buckup/output_Wplusenu5/elPt/Bias_Wplusenu5.root")

IdSF_plusenu5       = ROOT.TFile.Open("/afs/cern.ch/work/h/hatmani/HistMaker_v1/Plotting/RooUnfold/buckup/output_Wplusenu5/elPt/Syst_ElIDSys.root")
IsoSF_plusenu5      = ROOT.TFile.Open("/afs/cern.ch/work/h/hatmani/HistMaker_v1/Plotting/RooUnfold/buckup/output_Wplusenu5/elPt/Syst_ElIsoSys.root")
RecoSF_plusenu5     = ROOT.TFile.Open("/afs/cern.ch/work/h/hatmani/HistMaker_v1/Plotting/RooUnfold/buckup/output_Wplusenu5/elPt/Syst_ElRecoSys.root")
TrigSF_plusenu5     = ROOT.TFile.Open("/afs/cern.ch/work/h/hatmani/HistMaker_v1/Plotting/RooUnfold/buckup/output_Wplusenu5/elPt/Syst_ElTrigSys.root")
Calib_plusenu5      = ROOT.TFile.Open("/afs/cern.ch/work/h/hatmani/HistMaker_v1/Plotting/RooUnfold/buckup/output_Wplusenu5/elPt/Calib_Syst.root")
Recoil_plusenu5     = ROOT.TFile.Open("/afs/cern.ch/work/h/hatmani/HistMaker_v1/Plotting/RooUnfold/buckup/output_Wminusenu5/elPt/Recoil_Syst.root")
...
#Optimisation1B.StatStudy(Summarize_plusenu5, 1, 10,  35, "Wplusenu5", "W^{+}#rightarrow e^{+}#nu, 5TeV", "ptl")    # define the number of iterations for the study
#Optimisation1B.BiasStudy(Summarize_plusenu5, Bias_plusenu5, 1, 10,  35, "Wplusenu5", "W^{+}#rightarrow e^{+}#nu, 5TeV", "ptl")    # define the number of iterations for the study
#Optimisation1B.TotalStudy(Summarize_plusenu5, Bias_plusenu5, TrigSF_plusenu5, RecoSF_plusenu5, IsoSF_plusenu5, IdSF_plusenu5, Calib_plusenu5, Recoil_plusenu5, 1, 9,  35,  "Wplusenu5", "W^{+}#rightarrow e^{+}#nu, 5TeV",  "$p^{T}_{W}$")
