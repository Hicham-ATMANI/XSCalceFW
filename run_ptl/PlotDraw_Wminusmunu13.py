...
# minus enu 5 TeV
MCsamples_minusmunu5  = ROOT.TFile.Open("/eos/user/h/hatmani/DataSets/DataSets_13TeV/pTWanalysis_wminusmunu_MC_13TeV/Nominal/mc16_13TeV.361104.PowhegPythia8EvtGen_AZNLOCTEQ6L1_Wminusmunu.e3601_s3126_r10244+r11165_p3665.root")
Summarize_minusmunu5  = ROOT.TFile.Open("/afs/cern.ch/work/h/hatmani/HistMaker_v1/Plotting/RooUnfold/output_Wminusmunu13/muPt/Summarize_Wminusmunu13.root")
Bias_minusmunu5       = ROOT.TFile.Open("/afs/cern.ch/work/h/hatmani/HistMaker_v1/Plotting/RooUnfold/output_Wminusmunu13/muPt/Bias_Wminusmunu13.root")

IsoSF_minusmunu5      = ROOT.TFile.Open("/afs/cern.ch/work/h/hatmani/HistMaker_v1/Plotting/RooUnfold/output_Wminusmunu13/muPt/Syst_MuRecoSys.root")
RecoSF_minusmunu5     = ROOT.TFile.Open("/afs/cern.ch/work/h/hatmani/HistMaker_v1/Plotting/RooUnfold/output_Wminusmunu13/muPt/Syst_MuRecoSys.root")
TrigSF_minusmunu5     = ROOT.TFile.Open("/afs/cern.ch/work/h/hatmani/HistMaker_v1/Plotting/RooUnfold/output_Wminusmunu13/muPt/Syst_MuTrigSys.root")
Recoil_minusmunu5     = ROOT.TFile.Open("/afs/cern.ch/work/h/hatmani/HistMaker_v1/Plotting/RooUnfold/output_Wminusmunu13/muPt/Recoil_Syst.root")
...
#NominalPlots.GetEpsilonFactors(Summarize_minusmunu5,                "Wminusmunu13",   "W^{-}#rightarrow #mu^{-}#nu,   13TeV")
#NominalPlots.MigrationMatrix(Summarize_minusmunu5,                  "Wminusmunu13",   "W^{-}#rightarrow #mu^{-}#nu,   13TeV")
#NominalPlots.ShowNominalDistribution(Summarize_minusmunu5,          "Wminusmunu13",   "W^{-}#rightarrow #mu^{-}#nu,   13TeV")
#NominalPlots.CompareBias(Bias_minusmunu5, 1,  9,                   "Wminusmunu13",   "W^{-}#rightarrow #mu^{-}#nu,   13TeV")
#NominalPlots.CompareStatError(Summarize_minusmunu5, 1,  9,         "Wminusmunu13",   "W^{-}#rightarrow #mu^{-}#nu,   13TeV")
#NominalPlots.BiasProcedure( Summarize_minusmunu5, Bias_minusmunu5,  "Wminusmunu13",   "W^{-}#rightarrow #mu^{-}#nu,   13TeV" )
...
#SystematicsStudy.CompareSystIso(  IsoSF_minusmunu5,  1, 10, "Wminusmunu13",   "W^{-}#rightarrow #mu^{-}#nu,   13TeV")
#SystematicsStudy.CompareSystReco( RecoSF_minusmunu5, 1, 10, "Wminusmunu13",   "W^{-}#rightarrow #mu^{-}#nu,   13TeV")
...
#CrossSectionDeter.GetDiffernetialXs(Summarize_minusmunu5, Bias_minusmunu5, TrigSF_minusmunu5, RecoSF_minusmunu5, IsoSF_minusmunu5, IsoSF_minusmunu5, IsoSF_minusmunu5, Recoil_minusmunu5, "13TeV", "W$^{-}$ $\\rightarrow$ $\\mu^{-} \\nu $, 13TeV, Uncertainties in (\%)", "Wminusmunu13", 339.8, 2)
CrossSectionDeter.GetDiffernetialXs(Summarize_minusmunu5, Bias_minusmunu5, TrigSF_minusmunu5, RecoSF_minusmunu5, IsoSF_minusmunu5, IsoSF_minusmunu5, IsoSF_minusmunu5, Recoil_minusmunu5, "13TeV", "W^{-}#rightarrow #mu^{-}#nu , 13TeV, Uncertainties in (%)", "Wminusmunu13", 339.8, 2)
